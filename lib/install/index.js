...
const load = async (cmd) => {
  ...
  try {
    //读取package.rig.json5
    let package.rig.json5Str = fs.readFileSync('package.rig.json5.json5');
    let package.rig.json5 = json5.parse(package.rig.json5Str);
    //重置rigs rigs_dev
    ...
    for (let dep of package.rig.json5) {
      let target = 'rigs'
